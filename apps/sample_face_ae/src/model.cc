...
std::string Model::model_name() const { return model_name_; }
...
dims_t Model::input_shape(size_t idx) { return interp_.input_shape(idx); }

dims_t Model::output_shape(size_t idx) { return interp_.output_shape(idx); }
